      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-3 gap-8">
           ...
           <div className="space-y-8">
              <div className="bg-[#094090] text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
                 ...
                 <ul className="space-y-6">
                    <li className="flex items-start gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-sm text-blue-200">World-renowned experts from industry and academia.</p>
                       </div>
                    </li>
                    <li className="flex items-start gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-sm text-blue-200">Covering all major areas of power engineering.</p>
                       </div>
                    </li>
                    <li className="flex items-start gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-sm text-blue-200">Gala dinner and welcome reception in Penang.</p>
                       </div>
                    </li>
                 </ul>
                 <button className="w-full mt-10 py-4 bg-[hsl(var(--accent))] text-[#094090] font-bold rounded-xl hover:scale-105 transition-transform">
