      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        {!isSpecial ? (
          ...
          <div className="max-w-4xl mx-auto">
             ...
             <div className="bg-[#094090] text-white p-12 rounded-[3rem] shadow-2xl mt-16 relative overflow-hidden">
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-white/5 rounded-full -ml-32 -mb-32" />
                <h3 className="text-3xl font-bold mb-6 font-display">Guidelines for Organizers</h3>
                <p className="text-blue-100 text-lg mb-8 leading-relaxed">Special sessions provide a focused forum for new topics or innovative applications. Organizers are responsible for inviting papers and managing the review process.</p>
                ...
                <button className="px-8 py-4 bg-[hsl(var(--accent))] text-[#094090] font-bold rounded-xl hover:scale-105 transition-all">
