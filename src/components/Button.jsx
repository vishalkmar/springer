...
export function Button({
  ...
  const variants = {
    primary:
      "bg-primary text-white hover:bg-primary/90 hover:shadow-lg focus:ring-primary",
    secondary:
      "bg-secondary text-secondary-foreground hover:bg-secondary/80 focus:ring-secondary",
    outline:
      "border-2 border-primary text-primary hover:bg-primary/5 focus:ring-primary",
    accent:
      "bg-[hsl(var(--accent))] text-white hover:bg-[hsl(var(--accent))]/90 shadow-md hover:shadow-xl focus:ring-[hsl(var(--accent))]",
  };
