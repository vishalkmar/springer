...
//     // wa.me expects URL encoded text
//     const waUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
//       text.replace(/%0A/g, "\n") // keep lines nice; encodeURIComponent will re-encode
//     )}`;
...
//     setTimeout(() => {
//       setLoading(false);
//       alert("Opening WhatsApp… Please tap Send to submit your message.");
//       form.reset();
//     }, 500);
//   };
...
//                     <p className="mt-1 text-sm text-slate-500">Mon - Fri, 10:00 AM - 6:00 PM (IST)</p>
//                   </div>
//                 </div>
...
//                   </div>
//                   <div className="min-w-0">
//                     <h4 className="text-lg font-semibold text-slate-900">Conference Location</h4>
...
export default function Contact() {
  ...
  const RECEIVER_EMAIL = "info@ICSCPSIA.org";
...
`;
    ...
    const mailtoLink =
      ...
      `?subject=${encodeURIComponent(subject || "Conference Inquiry")}` +
            ...
            <div>
              ...
              <div className="mt-10 space-y-7">
                ...
                <div className="group flex items-start gap-5 rounded-2xl bg-white p-5 ring-1 ring-slate-200 transition-all hover:-translate-y-0.5 hover:shadow-md hover:ring-[#42a1f5]/35">
                  ...
                  <div className="min-w-0">
                    <h4 className="text-lg font-semibold text-slate-900">Email Inquiries</h4>
                    <p className="mt-1 font-medium text-[#42a1f5]">{RECEIVER_EMAIL}</p>
                    <p className="mt-1 text-sm text-slate-500">Typical response within 24 hours</p>
                  </div>
                </div>
